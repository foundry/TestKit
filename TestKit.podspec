#
#  Be sure to run `pod spec lint TestFKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "foundry"
  # s.authors            = { "foundry" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/foundry"
